    ...
    public partial class AddEditExchangeOrder : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            var order = new Models.ExchangeOrder()
            {
                ...
                SourceWarehouse = (Models.Warehouse)cbSourceWarehouses.SelectedItem,
                DestinationWarehouse = (Models.Warehouse)cbDestinationWarehouses.SelectedItem,
            };
            ...
            foreach (DataGridViewRow row in dgvSelectedItems.Rows)
            {
                ...
                {
                    Warehouse = (Models.Warehouse)cbDestinationWarehouses.SelectedItem,
